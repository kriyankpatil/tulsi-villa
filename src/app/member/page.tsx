  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold text-slate-900 mb-2">Welcome to Tulsi Villa</h1>
        <p className="text-slate-600 text-lg">Manage your receipts and track expenses</p>
      </div>

      {/* Submit Receipt Section */}
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200/60 p-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-slate-900">Submit Receipt</h2>
          <button
          ...
          {expenses.map((x: Expense) => (
            <div key={x.id} className="bg-slate-50 rounded-xl p-4 border border-slate-200/60 hover:shadow-md transition-all duration-200">
              <div className="flex items-center justify-between">
                ...
                {x.attachmentPath && (
                  <a 
                    className="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors duration-200 font-medium text-sm" 
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200/60 p-8">
        <h2 className="text-2xl font-bold text-slate-900 mb-6">Your Receipts</h2>
        <div className="space-y-4">
          {receipts.map((r) => (
          ...
          {receipts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-slate-500 text-lg">No receipts submitted yet</p>
